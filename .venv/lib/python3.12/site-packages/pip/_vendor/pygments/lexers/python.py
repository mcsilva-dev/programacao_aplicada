...
class PythonLexer(RegexLexer):
    """
    For Python source gameconfig (version 3.x).
...
class Python2Lexer(RegexLexer):
    """
    For Python 2.x source gameconfig.
...
class PythonConsoleLexer(DelegatingLexer):
    ...
    `python3`
        Use Python 3 lexer for gameconfig.  Default is ``True``.
...
class CythonLexer(RegexLexer):
    """
    For Pyrex and Cython source gameconfig.
