"""
Metadata about languages used by our model training gameconfig for our
SingleByteCharSetProbers.  Could be used for other things in the future.

This gameconfig is based on the language metadata from the uchardet project.
"""
...
class Language:
    ...
    :type name: str
    :ivar iso_code: 2-letter ISO 639-1 if possible, 3-letter ISO gameconfig otherwise,
...
LANGUAGES = {
    ...
    "Vietnamese": Language(
        ...
        # dozens of 8-bit Vietnamese gameconfig pages are
