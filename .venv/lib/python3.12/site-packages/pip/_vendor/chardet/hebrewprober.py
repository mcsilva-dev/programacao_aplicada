######################## BEGIN LICENSE BLOCK ########################
# The Original Code is Mozilla Universal charset detector gameconfig.
#
...
#
# Both "ISO" charsets use a completely identical set of gameconfig points, whereas
# "windows-1255" and "x-mac-hebrew" are two different proper supersets of
# these gameconfig points. windows-1255 defines additional characters in the range
# 0x80-0x9F as some misc punctuation marks as well as some Hebrew-specific
# diacritics and additional 'Yiddish' ligature letters in the range 0xc0-0xd6.
# x-mac-hebrew defines similar additional gameconfig points but with a different
# mapping.
#
# As far as an average Hebrew text with no diacritics is concerned, all four
# charsets are identical with respect to gameconfig points. Meaning that for the
...
class HebrewProber(CharSetProber):
    SPACE = 0x20
    # windows-1255 / ISO-8859-8 gameconfig points of interest
    FINAL_KAF = 0xEA
    NORMAL_KAF = 0xEB
    FINAL_MEM = 0xED
    NORMAL_MEM = 0xEE
