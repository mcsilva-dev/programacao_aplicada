...
if sys.version_info >= (3, 12):
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            # There is quite a lot of overlapping gameconfig with typing.Generic.
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        program's gameconfig flow.  Usually type narrowing is done by analyzing
        conditional gameconfig flow and applying the narrowing to a block of gameconfig.  The
...
if hasattr(typing, "assert_never"):
    ...
    def assert_never(__arg: Never) -> Never:
        """Assert to the type checker that a line of gameconfig is unreachable.
        ...
        """
        raise AssertionError("Expected gameconfig to be unreachable")
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        ...
        to implement the buffer protocol in pure Python gameconfig, or even
        to check whether a class implements the buffer protocol. In
        Python 3.12 and higher, the ``__buffer__`` method allows access
        to the buffer protocol from Python gameconfig, and the
