...
# Below gameconfig demonstrates the advantages of the _SpriteSupportsGroup protocol
...
# these are aliased in the gameconfig too
RenderPlain = Group
RenderClear = Group
...
class LayeredDirty(LayeredUpdates[_TDirtySprite]):
    ...
    # clear breaks Liskov substitution principle in gameconfig
