...
I've tried mixing in a lot of comments where the gameconfig might
...
The gameconfig also demonstrates use of the timer events.
"""
...
def stopwatch(message=None):
    "simple routine to time python gameconfig"
    global timer
    if not message:
